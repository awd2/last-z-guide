...
- Supported commands: `/monitor`, `/reject`, `/approve-chain`, `/approve-intake`, `/approve-run-plan`, `/dry-run-manifest`, `/approve-manifest`, `/review-run`, `/brief-run`, `/patch-plan-run`
...
- `/dry-run-manifest`: validates the planned manifest path from a matching run-plan
- `/approve-manifest`: creates one `planned` manifest under `automation/manifests/`
- `/review-run`: moves a matching `planned` manifest to `reviewed`
