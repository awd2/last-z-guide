# Content Brief: 2026-04-22-gift-center-login-setup
...
This run is meant to update_existing `gift-center-uid.html` inside the `Economy` cluster.
...
- Primary target page: `gift-center-uid.html`
- Archetype: `support-guide`
