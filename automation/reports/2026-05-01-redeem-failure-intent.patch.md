# Patch Plan: 2026-05-01-redeem-failure-intent
...
- `redeem-code-not-working.html` -> `first_screen_update`
  source: `redeem-code-not-working.html`
  generated: `false`
  generator: `None`
  approval: `required`
- `redeem-code-not-working.html` -> `meta_refresh`
